...
const DeleteRequestedEvent = ({ open, handleClose, reviewId, onSuccess }) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            const response = await axios({
                url: `${appUrl}/admin/delete-event/${reviewId}`,
                ...
                <Fade in={open}>
                    <Box sx={style}>
                        ...
                        <Typography sx={{ mt: 2, color: "white", textAlign: "center" }}>
                            Are you sure you want to delete this requested event?
                        </Typography>
