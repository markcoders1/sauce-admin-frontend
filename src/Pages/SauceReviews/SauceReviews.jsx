...
import ConfirmDeleteModalSauceReview from "../../Components/ConfirmDeleteModalSauceReview/ConfirmDeleteModalSauceReview"
  ...
  const fetchReviews = async (currentPage, search) => {
    try {
      ...
      const response = await axios({
        url: `${appUrl}/admin/get-specific-sauce-reviews/${id}`, // Dummy API endpoint for now
        method: "get",
        headers: {
